  ...
  <div class="col-md-8">
    <div class="panel panel-default card">
      <div class="panel-body card-body pt-4">
        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ url('admin/planes/'.$plan->id) }}">
          {{ csrf_field() }}
          ...
          <div class="form-group row justify-content-center">
           ...
           @endif
           <div class="col-md-10">
            <input id="title" type="text" class="form-control" name="title" value="{{ $plan->title }}" required autofocus>
           </div>
          </div>
          ...
          <div class="form-group row justify-content-center">
           ...
           @endif
           <div class="col-md-10">
            <input id="subtitle" type="text" class="form-control" name="subtitle" value="{{ $plan->subtitle }}" required>
           </div>
          </div>
          ...
          <div class="form-group row justify-content-center">
           ...
           @endif
           <div class="col-md-10">
            <textarea id="body" type="text" class="form-control ckeditor" name="body">{{ $plan->body }}</textarea>
           </div>
          </div>
          ...
          <div class="form-group row justify-content-center">
           ...
           @endif
           <div class="col-md-10">
            <input id="profile_title" type="text" class="form-control" name="profile_title" value="{{ $plan->profile_title }}" required>
           </div>
          </div>
          ...
          <div class="form-group row justify-content-center">
           ...
           @endif
           <div class="col-md-10">
            <textarea id="profile_body" type="text" class="form-control ckeditor" name="profile_body" value="{{ $plan->profile_body }}">{{ $plan->profile_body }}</textarea>
           </div>
          </div>
